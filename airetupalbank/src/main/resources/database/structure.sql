CREATE TABLE IF NOT EXISTS users(id INT PRIMARY KEY, nombre VARCHAR(50), role VARCHAR(50), email VARCHAR(50),password VARCHAR(50) );
CREATE TABLE IF NOT EXISTS bills(reference VARCHAR(10) PRIMARY KEY, price INT, paid VARCHAR(6), id_cliente INT);
